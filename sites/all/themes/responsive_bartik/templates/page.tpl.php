...
<div class="col-xs-12 col-sm-4 col-md-4 col-lg-6 pdngdefaultnone">
          <div class="lifemessage txtalignrgt"> <img width="406" height="15" title="linebar" alt="linebar" src="<?php echo $base_url."/".$path_to_theme;?>/images/linebar.png">
...
<?php print render($page['site_quotes']); ?>
		   ...
		   <!--h2>My life is my message</h2>
            ...
            <img width="406" height="15" title="linebar" alt="linebar" src="<?php echo $base_url."/".$path_to_theme;?>/images/linebar.png"> </div>
        </div>
